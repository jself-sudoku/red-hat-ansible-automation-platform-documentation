...
=======
:EDAcontroller: Event-Driven controller
>>>>>>> 765bea98 (AAP-12753 Updated attributes.adoc with Event-driven Ansible namees)
=======
:EDAcontroller: Event-Driven Ansible controller
>>>>>>> 4827d434 (AAP-12753 Added Ansible to controller name)
